...
####
#### Power variable of cheeta is model.actuator_gear
####
#### Mass: Can scale total mass at runtime with mj_setTotalmass
...
from .modifiable_classic_control.utils import uniform_exclude_inner
